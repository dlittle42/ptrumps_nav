/*
 ...
 MyFonts Webfont Build ID 2902569, 2014-10-15T11:37:30-0400
 ...
 Webfont: FF Good Web Pro Medium by FontFont
 URL: http://www.myfonts.com/fonts/fontfont/good-pro/medium/
 Copyright: 2010 published by FontShop International GmbH
 Licensed pageviews: 500,000


 License: http://www.myfonts.com/viewlicense?type=web&buildid=2902569
...
for(var fonts=[{fontFamily:"FFGoodWebProMedium",url:wfpath+"2C4A29_0"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+";");fonts[i].fontStyle&&(css+="font-style: "+fonts[i].fontStyle+";");
