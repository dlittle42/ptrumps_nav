...
var _demo = (function(){
    var _current_feed = 0, _current_section = null, _dir, method = {
            ...
            jQuery('.mainNavBtn, .moreNavItem').each(function(){
                jQuery(this).find('a').on('click', function(e){
                    ...
                    if(jQuery(this).attr('id').split('menu_')[1] != _current_section && jQuery(this).attr('id') != 'menu_more' && jQuery(this).attr('id') != 'linkPF') {
                        ...
                        (jQuery('.moveNavMenu').hasClass('moveNavMenuActive')) ? jQuery('.moveNavMenu').removeClass('moveNavMenuActive') : jQuery('.moveNavMenu').addClass('moveNavMenuActive');
                    }
                });
            });
        },
        ...
        show_section: function(section){
            ...
            setTimeout(function(){
                if (jQuery('.moveNavMenu').hasClass('moveNavMenuActive')) {
                    jQuery('.moveNavMenu').removeClass('moveNavMenuActive')
                }
